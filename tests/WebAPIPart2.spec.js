//This is to be done when the login is complex
//Loging UI ----- .json file will store all the storage data while logged in
//test browser(inject json directly inside browser), cart,order,orderdetails, orderhistory
...
test.beforeAll(async ({ browser }) => {
  ...
  //this time by creating a new context we are injecting the storage data
